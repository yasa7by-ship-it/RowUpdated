-- #############################################################################
-- # إنشاء RPC function لتحديث evaluate_and_save_forecasts مباشرة
-- # يجب تنفيذ هذا الملف أولاً في Supabase SQL Editor
-- #############################################################################

BEGIN;

-- إنشاء وظيفة لتحديث evaluate_and_save_forecasts
CREATE OR REPLACE FUNCTION public.update_evaluate_function_v2()
RETURNS text
LANGUAGE plpgsql
SECURITY DEFINER

...
const ForecastAccuracy: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Stock Performance Table - FIRST - Compact Width */}
      <div className="flex justify-center">
        <div className="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="p-3 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-3">{t('by_stock_performance')}</h2>
      ...
      {/* Bias Analysis & Confidence Level - Compact Side by Side */}
      <div className="flex justify-center">
        <div className="w-full max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Confidence Level */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <h2 className="text-sm font-bold text-gray-900 dark:text-white mb-3">{t('by_confidence_level')}</h2>

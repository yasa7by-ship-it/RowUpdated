...
const StatCard: React.FC<{ title: string; value: number | string; icon: React.ReactNode }> = ({ title, value, icon }) => (
  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex items-center">
    <div className="p-3 rounded-full bg-nextrow-primary/20 dark:bg-nextrow-primary/40 text-nextrow-primary mr-4 rtl:mr-0 rtl:ml-4">
      {icon}
    </div>
    <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select id="watchlist_disclaimer_color" value={watchlistDisclaimerColor} onChange={(e) => setWatchlistDisclaimerColor(e.target.value)}
                                            ...
                                            <option value="text-nextrow-danger">أحمر</option>
...
const ManualTriggers: React.FC = () => {
    ...
    // تنسيق الوقت - التاريخ الميلادي YYYY/MM/DD 24H:MM

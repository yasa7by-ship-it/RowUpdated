-- #############################################################################
-- # سكريبت شامل لتحديث النظام بالكامل
-- # يتضمن: تحديث الوظيفة + إضافة الترجمات
-- #############################################################################

BEGIN;

-- ============================================================================
-- الجزء 1: تحديث وظيفة evaluate_and_save_forecasts
-- ============================================================================
...
-- التحقق من النتائج
SELECT '✅ تم تحديث الوظيفة بنجاح' AS status;
